...
import com.example.ordertickets.Models.Cast
import com.example.ordertickets.databinding.ViewholderCastBinding
    ...
    inner class ViewHolder(private val binding: ViewholderCastBinding):
        ...
        fun bind(cast: Cast){
            context?.let{
                Glide.with(it)
                    .load(cast.PicUrl)
                    .into(binding.imgVActor)
            }
            binding.tvNameTxt.text=cast.Actor
        }
    }
